      ...
      <Card>
        <SoftBox pt={2} pb={3} px={3} mu={5}>
          <SoftBox component="form" role="form">
            <SoftBox mb={2}>
              <SoftInput placeholder="Semester Number" value={item.semesternumber} name="semesternumber" onChange={(e) => handel(e)} />

            </SoftBox>
            <SoftBox mb={2}>
              <SoftInput type="number" placeholder="Total Students" value={item.students} name="students" onChange={(e) => handel(e)} />
            </SoftBox>
            <SoftBox mb={2}>
              <SoftInput type="text" placeholder="Total Courses" value={item.totalcourses} name="totalcourses" onChange={(e) => handel(e)} />
            </SoftBox>
